      ...
      <div className="w-full max-w-md rounded-2xl border border-black/10 bg-white p-8 shadow-sm space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-black/60">
            Front-of-house experience for travellers. Authentication is mocked
            for this demo.
          </p>
        </div>
        ...
        <div className="space-y-3 border-t border-dashed border-black/10 pt-4">
          <p className="text-xs text-black/70">
            This is a demo application, sign in as a guest to get mock
            credentials in order to see the checkout flow.
          </p>
          <Button
            className="w-full"
